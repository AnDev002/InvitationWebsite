...
import { useAuth } from '../../Context/AuthContext'; // Bỏ comment nếu bạn dùng

// --- CÁC ICON (SVG) ĐƯỢC TÍCH HỢP SẴN ---
const BackIcon = () => (
...
// --- COMPONENT CSS (Đồng bộ với trang Sign Up) ---
const Styles = () => (
    <style>{`
      /* Import SVN-Gilroy Font */
      @import url('https://fonts.cdnfonts.com/css/svn-gilroy');

      /* Đổi tên class để dùng chung */
      .auth-page-wrapper {
      ...
      .form-options {
          ...
          align-items: center;
          margin: 8px 0; /* Thêm margin cho cân đối */
      }
