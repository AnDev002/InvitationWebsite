...
// ----- COMPONENT MỚI: ToastNotification -----
...
const AccountSettingsPage = () => {
    ...
    const handleChangePassword = async (passwordData) => {
        try {
            ...
            // Giả lập lỗi từ server để hiển thị toast
    ...
    return (
        <main className="settings-page-wrapper">
            <Styles />
            {toast.visible && <ToastNotification message={toast.message} type={toast.type} onClose={() => setToast({ ...toast, visible: false })} />}
